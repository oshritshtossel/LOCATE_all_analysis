...
from Models.SPARSENED.sparse_ned_models import AE, MLPerceptron, Decoder
from Models.SPARSENED.sparse_ned_snip.snip import snip_forward_linear, snip_forward_conv2d
...
class BiomeLassoAESnip():
    ...
    def fit(self, X1_train, X2_train, y_train, X1_val, X2_val, y_val, args, ):
        ...
        X2_train_res = (X2_train_res - 0) /1
        # X2_val_res = (X2_val_res - 0)
